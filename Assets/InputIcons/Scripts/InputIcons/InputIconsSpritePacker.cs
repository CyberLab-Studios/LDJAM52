...
namespace InputIcons
{
    public static class InputIconsSpritePacker
    {
        ...
        {
            Debug.Log("Packing icon sets into sprite assets ...");
            List<InputIconSetBasicSO> iconSOs = GetInputIconSetScriptableObjects();
        ...
        public static Object PackIconSet(InputIconSetBasicSO iconSet)
        {
            ...
            if (iconSet != null)
            {
                if(iconSet.deviceDisplayName == "")
                {
                    Debug.LogError("Device display name must not be empty. Aborting packing icon set "+iconSet.name, iconSet);
                    return null;
                }
        ...
        public static Object PackInputIconSetToSpriteAtlasAndAssets(InputIconSetBasicSO iconSet)
        {
            ...
            Debug.Log("pack iconset: " + iconSet.deviceDisplayName +"...");
            ...
            string atlasFileName = InputIconsManagerSO.Instance.TEXTMESHPRO_SPRITEASSET_FOLDERPATH +iconSet.deviceDisplayName+  ".png";
        ...
        public static List<InputIconSetBasicSO> GetInputIconSetScriptableObjects()
        {
            ...
            foreach (string path in paths)
            {
                ...
                if (iconSO == null)
                    Debug.LogWarning("InputIconSetSO at " + filePath + " could not be loaded.");
                else
                {
                    iconSOs.Add(iconSO);
                }
