...
namespace InputIcons
{
    ...
    public class InputIconSetKeyboardEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            iconSet.deviceDisplayName = EditorGUILayout.TextField("Device Display Name", iconSet.deviceDisplayName);
            ...
            EditorGUILayout.HelpBox("To change the used sprites more conveniently, drag this icon set into a folder containing sprites. " +
                ...
                "Check if all sprites were found, then use the \"Pack to Sprite Asset\" button above.", MessageType.Info);
        ...
        private InputSpriteData DrawDeviceField(InputSpriteData data)
        {
            ...
            EditorGUILayout.LabelField("Button " + data.GetButtonName());
